...
app.get('/user/:userId', async (req, res, next) => {
  console.log('這裡是 /user/edit/:userId', req.params.userId) 
  let [data] = await pool.query('SELECT * FROM user WHERE id=?', [
    req.params.userId,
  ])
  res.json(data)
...
app.get('/user/reserver/:userReserverID', async (req, res, next) => {
  console.log('這裡是 /user/reserver/:', req.params.userReserverID) 
  let [data] = await pool.query(
...
app.put('/orders/updateStatus/:ordersID', async (req, res, next) => {
  console.log('這裡是 /orders/updateStatus/:ordersID', req.params.ordersID) 
